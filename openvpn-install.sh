#!/bin/bash
#
# https://github.com/angeloorru/openvpn-install
#
# Copyright (c) 2025 AngeloOrru. Released under the MIT License.
...
if ! grep -q sbin <<< "$PATH"; then
	echo 'Adding sbin directories to PATH for this session...'
